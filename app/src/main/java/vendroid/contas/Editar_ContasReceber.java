...
public class Editar_ContasReceber extends Activity {
	...
	public void Lista () {
		lstviewParcelas.setOnItemClickListener(new OnItemClickListener() {
			 public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				 final String codigo = (String) ((TextView)arg1.findViewById(R.id.EditarContasLinhas_txvCodigo)).getText();
				 	id = codigo;
				 	txvCodigo.setText(id);
				 	try {
						edtCliente.setText(tblCliente.Nome_por_Cliente(registro.Cliente(id)));
	...
	public void AtribuicaoObjetos() {
		txvData = (TextView) findViewById(R.id.EditarContasReceber_txvData);
		txvCodigo = (TextView) findViewById(R.id.EditarContasReceber_txvCodigo);
		btnVoltar = (Button) findViewById(R.id.EditarContasReceber_btnVoltar);
		btnBaixa = (Button) findViewById(R.id.EditarContasReceber_btnBaixa);
		btnEditarData = (Button) findViewById(R.id.EditarContasReceber_btnEditarData);
		btnExcluir = (Button) findViewById(R.id.EditarContasReceber_btnExcluir);
		btnRefatorar = (Button) findViewById(R.id.EditarContasReceber_btnRefatorar);
		edtCliente = (EditText) findViewById(R.id.EditarContasReceber_edtCliente);
		edtCodigoVenda = (EditText) findViewById(R.id.EditarContasReceber_edtCodigoVenda);
		edtDataVencimento = (EditText) findViewById(R.id.EditarContasReceber_edtDataVencimento);
		edtFormaPagamento = (EditText) findViewById(R.id.EditarContasReceber_edtFormaPagamento);
		edtNumeroParcela = (EditText) findViewById(R.id.EditarContasReceber_edtQtdParcelas);
		edtValorParcela = (EditText) findViewById(R.id.EditarContasReceber_edtValorParcela);
		edtValorTotal = (EditText) findViewById(R.id.EditarContasReceber_edtValorTotal);
		lstviewParcelas = (ListView) findViewById(R.id.EditarContasReceber_lstviewParcelas);
	}
	...
	public void Botoes () {
		...
		btnRefatorar.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				final EditText edtdescontogeral = (EditText) dialogo.findViewById(R.id.CaixaDialogoVenda_edtDescontoGeral);
				final EditText edttotal = (EditText) dialogo.findViewById(R.id.CaixaDialogoVenda_edtTotal);
				edttotal.setEnabled(false);
				final EditText edttroco = (EditText) dialogo.findViewById(R.id.CaixaDialogoVenda_edtTroco);
				edttroco.setEnabled(false);
				final EditText edtpago = (EditText) dialogo.findViewById(R.id.CaixaDialogoVenda_edtValorPago);
				Button btnfinalizar = (Button) dialogo.findViewById(R.id.CaixaDialogoVenda_btnFinalizar);
				Button btncancelar = (Button) dialogo.findViewById(R.id.CaixaDialogoVenda_btnCancelar);
				TextView txvdescontogeral = (TextView) dialogo.findViewById(R.id.CaixaDialogoVenda_txvDescontoGeral);
				TextView txvtroco = (TextView) dialogo.findViewById(R.id.CaixaDialogoVenda_txvTroco);
				TextView txvtotal = (TextView) dialogo.findViewById(R.id.CaixaDialogoVenda_txvTotal);
				txvdescontogeral.setVisibility(View.INVISIBLE);
				txvtroco.setVisibility(View.INVISIBLE);
				edtdescontogeral.setVisibility(View.INVISIBLE);
