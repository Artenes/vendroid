...
public class Editar_Grupo extends Activity {
	...
	public void AtribuicaoObjetos() {
		txvData = (TextView) findViewById(R.id.EditarGrupos_txvData);
		txvCodigo = (TextView) findViewById(R.id.EditarGrupos_txvCodigo);
		btnEditar = (Button) findViewById(R.id.EditarGrupos_btnEditar);
		btnSalvar = (Button) findViewById(R.id.EditarGrupos_btnSalvar);
		btnCancelar = (Button) findViewById(R.id.EditarGrupos_btnCancelar);
		btnExcluir = (Button) findViewById(R.id.EditarGrupos_btnExcluir);
		edtDescricao = (EditText) findViewById(R.id.EditarGrupos_edtDescricao);
	}
