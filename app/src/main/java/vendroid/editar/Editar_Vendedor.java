...
public class Editar_Vendedor extends Activity {
	...
	public void AtribuicaoObjetos() {
		txvCodigo = (TextView) findViewById(R.id.EditarVendedor_txvCodigo);
		txvData = (TextView) findViewById(R.id.EditarVendedor_txvData);
		btnEditar = (Button) findViewById(R.id.EditarVendedor_btnEditar);
		btnSalvar = (Button) findViewById(R.id.EditarVendedor_btnSalvar);
		btnSalvar.setEnabled(false);
		btnCancelar = (Button) findViewById(R.id.EditarVendedor_btnCancelar);
		edtNome = (EditText) findViewById(R.id.EditarVendedor_edtNome);
		edtNome.setEnabled(false);
		edtSenha = (EditText) findViewById(R.id.EditarVendedor_edtSenha);
		edtSenha.setEnabled(false);
		edtComissao = (EditText) findViewById(R.id.EditarVendedor_edtComissao);
		edtComissao.setEnabled(false);
		btnExcluir = (Button) findViewById(R.id.EditarVendedor_btnExcluir);
	}
