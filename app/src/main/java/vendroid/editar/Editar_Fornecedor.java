...
public class Editar_Fornecedor extends Activity {
	...
	public void AtribuicaoObjetos() {
		txvData = (TextView) findViewById(R.id.EditarFornecedor_txvData);
		txvCodigo = (TextView) findViewById(R.id.EditarFornecedor_txvCodigo);
		txvCPF = (TextView) findViewById(R.id.EditarFornecedor_txvCPF);
		txvRG = (TextView) findViewById(R.id.EditarFornecedor_txvRG);
		btnEditar = (Button) findViewById(R.id.EditarFornecedor_btnEditar);
		btnSalvar = (Button) findViewById(R.id.EditarFornecedor_btnSalvar);
		btnCancelar = (Button) findViewById(R.id.EditarFornecedor_btnCancelar);
		btnExcluir = (Button) findViewById(R.id.EditarFornecedor_btnExcluir);
		edtNome = (EditText) findViewById(R.id.EditarFornecedor_edtNome);
		edtCPF = (EditText) findViewById(R.id.EditarFornecedor_edtCPF);
		edtRG = (EditText) findViewById(R.id.EditarFornecedor_edtRG);
		edtEndereco = (EditText) findViewById(R.id.EditarFornecedor_edtEndereco);
		edtBairro = (EditText) findViewById(R.id.EditarFornecedor_edtBairro);
		edtCidade = (EditText) findViewById(R.id.EditarFornecedor_edtCidade);
		edtCEP = (EditText) findViewById(R.id.EditarFornecedor_edtCEP);
		edtFoneUm = (EditText) findViewById(R.id.EditarFornecedor_edtFoneUm);
		edtFoneDois = (EditText) findViewById(R.id.EditarFornecedor_edtFoneDois);
		edtEmail = (EditText) findViewById(R.id.EditarFornecedor_edtEmail);
		spnUF = (Spinner) findViewById(R.id.EditarFornecedor_spnUF);
		tglbtnPessoa = (ToggleButton) findViewById(R.id.EditarFornecedor_tglbtnPessoa);
	}
