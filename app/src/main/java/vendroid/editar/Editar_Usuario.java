...
public class Editar_Usuario extends Activity{
	...
	public void AtribuicaoObjetos() {
		txvData = (TextView) findViewById(R.id.EditarUsuario_txvData);
		txvCodigo = (TextView) findViewById(R.id.EditarUsuario_txvCodigo);
		btnEditar = (Button) findViewById(R.id.EditarUsuario_btnEditar);
		btnSalvar = (Button) findViewById(R.id.EditarUsuario_btnSalvar);
		btnCancelar = (Button) findViewById(R.id.EditarUsuario_btnCancelar);
		btnExcluir = (Button) findViewById(R.id.EditarUsuario_btnExcluir);
		edtUsuario = (EditText) findViewById(R.id.EditarUsuario_edtNome);
		edtSenha = (EditText) findViewById(R.id.EditarUsuario_edtSenha);
	}
