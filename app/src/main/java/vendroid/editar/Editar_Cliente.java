...
public class Editar_Cliente extends Activity {
	...
	public void AtribuicaoObjetos() {
		txvCodigo = (TextView) findViewById(R.id.EditarCliente_txvCodigo);
		txvData = (TextView) findViewById(R.id.EditarCliente_txvData);
		btnEditar = (Button) findViewById(R.id.EditarCliente_btnEditar);
		btnSalvar = (Button) findViewById(R.id.EditarCliente_btnSalvar);
		btnCancelar = (Button) findViewById(R.id.EditarCliente_btnCancelar);
		btnExcluir = (Button) findViewById(R.id.EditarCliente_btnExcluir);
		edtNome = (EditText) findViewById(R.id.EditarCliente_edtNome);
		edtCPF = (EditText) findViewById(R.id.EditarCliente_edtCPF);
		edtRG = (EditText) findViewById(R.id.EditarCliente_edtRG);
		edtNascimento = (EditText) findViewById(R.id.EditarCliente_edtDataNascimento);
		edtEndereco = (EditText) findViewById(R.id.EditarCliente_edtEndereco);
		edtBairro = (EditText) findViewById(R.id.EditarCliente_edtBairro);
		edtCidade = (EditText) findViewById(R.id.EditarCliente_edtCidade);
		edtCEP = (EditText) findViewById(R.id.EditarCliente_edtCEP);
		edtFoneUm = (EditText) findViewById(R.id.EditarCliente_edtFoneUm);
		edtFoneDois = (EditText) findViewById(R.id.EditarCliente_edtFoneDois);
		edtEmail = (EditText) findViewById(R.id.EditarCliente_edtEmail);
		edtRota= (EditText) findViewById(R.id.EditarCliente_edtRota);
		edtRota.setKeyListener(null);
		spnUF = (Spinner) findViewById(R.id.EditarCliente_spnUF);
		tglbtnPessoa = (ToggleButton) findViewById(R.id.EditarCliente_tglbtnPessoa);
		txvCPF = (TextView) findViewById(R.id.EditarCliente_txvCPF);
		txvRG = (TextView) findViewById(R.id.EditarCliente_txvRG);
