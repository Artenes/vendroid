...
public class Editar_Marca extends Activity {
	...
	public void AtribuicaoObjetos() {
		txvData = (TextView) findViewById(R.id.EditarMarcas_txvData);
		txvCodigo = (TextView) findViewById(R.id.EditarMarcas_txvCodigo);
		btnEditar = (Button) findViewById(R.id.EditarMarcas_btnEditar);
		btnSalvar = (Button) findViewById(R.id.EditarMarcas_btnSalvar);
		btnCancelar = (Button) findViewById(R.id.EditarMarcas_btnCancelar);
		btnExcluir = (Button) findViewById(R.id.EditarMarcas_btnExcluir);
		edtDescricao = (EditText) findViewById(R.id.EditarMarcas_edtDescricao);
		edtFornecedor = (EditText) findViewById(R.id.EditarMarcas_edtFornecedor);
