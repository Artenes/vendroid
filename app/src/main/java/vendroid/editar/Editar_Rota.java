...
public class Editar_Rota extends Activity {
	...
	public void AtribuicaoObjetos() {
		txvData = (TextView) findViewById(R.id.EditarRotas_txvData);
		txvCodigo = (TextView) findViewById(R.id.EditarRotas_txvCodigo);
		btnEditar = (Button) findViewById(R.id.EditarRotas_btnEditar);
		btnSalvar = (Button) findViewById(R.id.EditarRotas_btnSalvar);
		btnCancelar = (Button) findViewById(R.id.EditarRotas_btnCancelar);
		btnExcluir = (Button) findViewById(R.id.EditarRotas_btnExcluir);
		edtDescricao = (EditText) findViewById(R.id.EditarRotas_edtDescricao);
		edtVendedor = (EditText) findViewById(R.id.EditarRotas_edtVendedor);
