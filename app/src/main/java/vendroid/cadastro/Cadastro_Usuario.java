...
public class Cadastro_Usuario extends Activity {
	...
	public void AtribuicaoObjetos() {
		btnCancelar = (Button) findViewById(R.id.CadastroUsuarios_btnCancelar);
		btnSalvar = (Button) findViewById(R.id.CadastroUsuarios_btnSalvar);
		edtNome = (EditText) findViewById(R.id.CadastroUsuarios_edtNome);
		edtSenha = (EditText) findViewById(R.id.CadastroUsuarios_edtSenha);
	}
