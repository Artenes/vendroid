...
Tabela_Codigos tblCodigos;
	...
	public void AtribuicaoObjetos () {
		btnSalvar = (Button) findViewById(R.id.CadastroGrupos_btnSalvar);
		btnCancelar = (Button) findViewById(R.id.CadastroGrupos_btnCancelar);
		edtDescricao = (EditText) findViewById(R.id.CadastroGrupos_edtDescricao);
	}
