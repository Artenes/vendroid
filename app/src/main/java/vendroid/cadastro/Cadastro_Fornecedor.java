...
int pessoa = 0;
	...
	public void AtribuicaoObjetos () {
		edtNome = (EditText) findViewById(R.id.CadastroFornecedor_EdtNome);
		edtCPF = (EditText) findViewById(R.id.CadastroFornecedor_EdtCPF);
		edtRG = (EditText) findViewById(R.id.CadastroFornecedor_EdtRG);
		edtEndereco = (EditText) findViewById(R.id.CadastroFornecedor_EdtEndereco);
		edtBairro = (EditText) findViewById(R.id.CadastroFornecedor_EdtBairro);
		edtCidade = (EditText) findViewById(R.id.CadastroFornecedor_EdtCidade);
		edtCEP = (EditText) findViewById(R.id.CadastroFornecedor_EdtCEP);
		edtTelFixo = (EditText) findViewById(R.id.CadastroFornecedor_EdtTelefoneFixo);
		edtTelCelular = (EditText) findViewById(R.id.CadastroFornecedor_EdtTelefoneCelular);
		edtEmail = (EditText) findViewById(R.id.CadastroFornecedor_EdtEmail);
		btnSalvar = (Button) findViewById(R.id.CadastroFornecedor_btnSalvar);
		btnCancelar = (Button) findViewById(R.id.CadastroFornecedor_btnCancelar);
		spnUF = (Spinner) findViewById(R.id.CadastroFornecedor_spnUF);
		txvCPF = (TextView) findViewById(R.id.CadastroFornecedor_txvCPF);
		txvRG = (TextView) findViewById(R.id.CadastroFornecedor_txvRG);
		tglbtnPessoa = (ToggleButton) findViewById(R.id.CadastroFornecedor_tglbtnPessoa);
	}
