...
Tabela_Codigos tblCodigos;
	...
	public void AtribuicaObjetos () {
		btnSalvar = (Button) findViewById(R.id.CadastroMarcas_btnSalvar);
		btnCancelar = (Button) findViewById(R.id.CadastroMarcas_btnCancelar);
		edtDescricao = (EditText) findViewById(R.id.CadastroMarcas_edtDescricao);
		edtFornecedor = (EditText) findViewById(R.id.CadastroMarcas_edtFornecedor);
