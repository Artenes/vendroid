...
public class Venda extends Activity {
	...
	protected void onCreate(Bundle State) {
		...
		adapter = new SimpleAdapter(contexto, list,
				...
				new int[] {R.id.VendaLinha_txvProduto, R.id.VendaLinha_txvDesconto, R.id.VendaLinha_txvValor,
							R.id.VendaLinha_txvQtd, R.id.VendaLinha_txvTotal});
	...
	private void AtribuicaoObjetos () {
			edtValorBruto = (EditText) findViewById(R.id.Venda_edtValorBruto);
			edtValorBruto.setEnabled(false);
			edtVendedor = (EditText) findViewById(R.id.Venda_edtVendedor);
			edtVendedor.setKeyListener(null);
			edtFormaPagamento = (EditText) findViewById(R.id.Venda_edtFormaPagamento);
			edtFormaPagamento.setKeyListener(null);
			edtCliente = (EditText) findViewById(R.id.Venda_edtCliente);
			edtCliente.setKeyListener(null);
			edtCodigo = (EditText) findViewById(R.id.Venda_edtCodigo);
			edtCodigo.setKeyListener(null);
			edtProduto = (EditText) findViewById(R.id.Venda_edtProduto);
			edtProduto.setKeyListener(null);
			edtPreco = (EditText) findViewById(R.id.Venda_edtPreco);
			edtPreco.setEnabled(false);
			edtQuantidade = (EditText) findViewById(R.id.Venda_edtQuantidade);
			edtDesconto = (EditText) findViewById(R.id.Venda_edtDesconto);
			edtTotal = (EditText) findViewById(R.id.Venda_edtTotal);
			edtTotal.setEnabled(false);
			edtTotalLiquido = (EditText) findViewById(R.id.Venda_edtTotalLiquido);
			edtTotalLiquido.setEnabled(false);
			btnLancarProduto = (Button) findViewById(R.id.Venda_btnLancarProduto);
			btnExcluirProduto = (Button) findViewById(R.id.Venda_btnExcluirProduto);
			btnFinalizarVenda = (Button) findViewById(R.id.Venda_btnFinalizarVenda);
			btnCancelarVenda = (Button) findViewById(R.id.Venda_btnCancelarVenda);
			spnPlanoPagamento = (Spinner) findViewById(R.id.Venda_spnPlanoPagamento);
			...
			listview = (ListView) findViewById(R.id.Venda_listview);
		}
	...
	private void ListaProdutos () {
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			 public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				 ...
				 Cursor codigo = tblProdutos.BuscapProduto(((TextView)arg1.findViewById(R.id.VendaLinha_txvProduto)).getText().toString());
				 codigo.moveToFirst();
				 
				 final String cod = codigo.getString(codigo.getColumnIndex("_id"));
				 final String produto = (String) ((TextView)arg1.findViewById(R.id.VendaLinha_txvProduto)).getText();
				 final String preco = (String) ((TextView)arg1.findViewById(R.id.VendaLinha_txvValor)).getText();
				 final String qtd = (String) ((TextView)arg1.findViewById(R.id.VendaLinha_txvQtd)).getText();
				 final String desc = (String) ((TextView)arg1.findViewById(R.id.VendaLinha_txvDesconto)).getText();
				 final String total = (String) ((TextView)arg1.findViewById(R.id.VendaLinha_txvTotal)).getText();
	...
	private void Botoes () {
		...
		btnLancarProduto.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {
				...
				if (Float.parseFloat(edtQuantidade.getText().toString()) > Float.parseFloat(tblProdutos.EstoqueAtual(edtCodigo.getText().toString()))) {
					...
					senha = (EditText) dialog.findViewById(R.id.CaixaDialogo_edtSenha);
					Button sim = (Button) dialog.findViewById(R.id.CaixaDialogo_btnSim);
		...
		btnFinalizarVenda.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {
				...
				final EditText edtdescontogeral = (EditText) dialog.findViewById(R.id.CaixaDialogoVenda_edtDescontoGeral);
				final EditText edttotal = (EditText) dialog.findViewById(R.id.CaixaDialogoVenda_edtTotal);
				edttotal.setEnabled(false);
				final EditText edttroco = (EditText) dialog.findViewById(R.id.CaixaDialogoVenda_edtTroco);
				edttroco.setEnabled(false);
				final EditText edtpago = (EditText) dialog.findViewById(R.id.CaixaDialogoVenda_edtValorPago);
				Button btnfinalizar = (Button) dialog.findViewById(R.id.CaixaDialogoVenda_btnFinalizar);
				Button btncancelar = (Button) dialog.findViewById(R.id.CaixaDialogoVenda_btnCancelar);
