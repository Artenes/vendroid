...
public class Consulta_Vendas extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		edtCodigo = (EditText) findViewById(R.id.ConsultaVendas_edtCodigo);
		edtCliente = (EditText) findViewById(R.id.ConsultaVendas_edtCliente);
		edtDataFinal = (EditText) findViewById(R.id.ConsultaVendas_edtDataFinal);
		edtDataFinal.setKeyListener(null);
		edtDataInicial = (EditText) findViewById(R.id.ConsultaVendas_edtDataInicial);
		edtDataInicial.setKeyListener(null);
		edtVendedor = (EditText) findViewById(R.id.ConsultaVendas_edtVendedor);
		btnVoltar = (Button) findViewById(R.id.ConsultaVendas_btnVoltar);
		btnPesquisar = (Button) findViewById(R.id.ConsultaVendas_btnPesquisar);
		listview = (ListView) findViewById(R.id.ConsultaVendas_list);
		...
		btnPesquisar.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {
				...
				dataSource = new SimpleCursorAdapter(
						...
						campos, 
						new int[] { R.id.ConsultaLinhasVendas_txvCodigo,
					R.id.ConsultaLinhasVendas_txvVendedor,
					R.id.ConsultaLinhasVendas_txvCliente,
					R.id.ConsultaLinhasVendas_txvData});
				listview.setAdapter(dataSource);
		...
		listview.setOnItemClickListener(new OnItemClickListener() {
			 public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				 final String text = (String) ((TextView)arg1.findViewById(R.id.ConsultaLinhasVendas_txvCodigo)).getText();
