...
public class LogIn extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		edtSenha = (EditText) findViewById(R.login.edtSenha);
		edtUsuario = (EditText) findViewById(R.login.edtUsuario);
		btnCancelar = (Button) findViewById(R.login.btnCancelar);
		btnEntrar = (Button) findViewById(R.login.btnEntrar);
