...
public class Cadastro_Administrador extends Activity{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		edtAdministrador = (EditText) findViewById(R.CadastroAdministrador.edtAdministrador);
		edtSenha = (EditText) findViewById(R.CadastroAdministrador.edtSenha);
		btnFinalizar = (Button) findViewById(R.CadastroAdministrador.btnFinalizar);
		btnCancelar = (Button) findViewById(R.CadastroAdministrador.btnCancelar);
