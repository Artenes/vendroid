...
public class Editar_Forma_Pagamento extends Activity {
	...
	public void AtribuicaoObjetos() {
		txvData = (TextView) findViewById(R.EditarFormasPagamento.txvData);
		txvCodigo = (TextView) findViewById(R.EditarFormasPagamento.txvCodigo);
		btnEditar = (Button) findViewById(R.EditarFormasPagamento.btnEditar);
		btnSalvar = (Button) findViewById(R.EditarFormasPagamento.btnSalvar);
		btnCancelar = (Button) findViewById(R.EditarFormasPagamento.btnCancelar);
		btnExcluir = (Button) findViewById(R.EditarFormasPagamento.btnExcluir);
		edtDescricao = (EditText) findViewById(R.EditarFormasPagamento.EdtDescricao);
		edtQuantidadeParcelas = (EditText) findViewById(R.EditarFormasPagamento.EdtQuantidadeParcela);
		edtDiasParcelas = (EditText) findViewById(R.EditarFormasPagamento.EdtDiasEntreParcela);
		edtAcressimo = (EditText) findViewById(R.EditarFormasPagamento.EdtAcressimo);
	}
