...
public class Consulta_Usuarios extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnCadastrar = (Button) findViewById(R.ConsultaUsuarios.btnCadastrar);
		edtCodigo = (EditText) findViewById(R.ConsultaUsuarios.edtCodigo);
		edtUsuario = (EditText) findViewById(R.ConsultaUsuarios.edtUsuario);
		btnPesquisar = (Button) findViewById(R.ConsultaUsuarios.btnPesquisar);
		btnVoltar = (Button) findViewById(R.ConsultaUsuarios.btnVoltar);
		listview = (ListView) findViewById(R.ConsultaUsuarios.list);
