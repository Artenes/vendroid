...
public class Consulta_Rotas_Falsa extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnCadastrar = (Button) findViewById(R.ConsultaRotas.btnCadastro);
		...
		btnPesquisar.setOnClickListener(new View.OnClickListener() {
			public void onClick(View arg0) {
				...
				dataSource = new SimpleCursorAdapter(context, R.layout.consulta_linhas, 
						helper.Busca_Falsa(ID, Rota), campos, new int[] {R.ConsultaLinhas.txvCodigo, 
		 ...
		 listview.setOnItemClickListener(new OnItemClickListener() {
			 public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
				 //Código para puxar dados de uma activity para outra
