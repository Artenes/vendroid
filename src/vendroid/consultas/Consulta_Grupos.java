...
public class Consulta_Grupos extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		edtBusca = (EditText) findViewById(R.ConsultaGrupos.edtBusca);
		edtCodigo = (EditText) findViewById(R.ConsultaGrupos.edtCodigo);
		btnBusca = (Button) findViewById(R.ConsultaGrupos.btnBusca);
		...
		btnBusca.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {	
				...
				dataSource = new SimpleCursorAdapter(context, R.layout.consulta_linhas, 
						helper.BuscaFiltro(id, grupo), campos, new int[] {R.ConsultaLinhas.txvCodigo, 
