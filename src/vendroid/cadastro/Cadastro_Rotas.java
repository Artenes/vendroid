...
public class Cadastro_Rotas extends Activity {
	...
	public void AtribuicaoObjetos () {
		edtDescricao = (EditText) findViewById(R.CadastroRotas.EdtDescricao);
		edtVendedor = (EditText) findViewById(R.CadastroRotas.EdtVendedor);
		btnCancelar = (Button) findViewById(R.CadastroRotas.btnCancelar);
		btnSalvar = (Button) findViewById(R.CadastroRotas.btnSalvar);
	}
