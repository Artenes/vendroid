...
public class Cadastro_Empresa extends Activity {
	...
	public void AtribuicaoObjetos() {
		btnSalvar = (Button) findViewById(R.CadastroEmpresa.btnSalvar);
		btnCancelar = (Button) findViewById(R.CadastroEmpresa.btnCancelar);
		edtRazaoSocial = (EditText) findViewById(R.CadastroEmpresa.edtRazaoSocial);
		edtNomeFantasia = (EditText) findViewById(R.CadastroEmpresa.edtNomeFantasia);
		edtCNPJ = (EditText) findViewById(R.CadastroEmpresa.edtCNPJ);
		edtInscricaoEstadual = (EditText) findViewById(R.CadastroEmpresa.edtInscricaoEstadual);
		edtEndereco = (EditText) findViewById(R.CadastroEmpresa.edtEndereco);
		edtBairro = (EditText) findViewById(R.CadastroEmpresa.edtBairro);
		edtCidade = (EditText) findViewById(R.CadastroEmpresa.edtCidade);
		edtCEP = (EditText) findViewById(R.CadastroEmpresa.edtCEP);
		edtRepresentante = (EditText) findViewById(R.CadastroEmpresa.edtRepresentante);
		edtFoneUm = (EditText) findViewById(R.CadastroEmpresa.edtTelefoneContatoUm);
		edtFonedois = (EditText) findViewById(R.CadastroEmpresa.edtTelefoneContatoDois);
		edtEmail= (EditText) findViewById(R.CadastroEmpresa.edtEmail);
		edtSite= (EditText) findViewById(R.CadastroEmpresa.edtSite);
		spnUF = (Spinner) findViewById(R.CadastroEmpresa.spnUF);
	}
