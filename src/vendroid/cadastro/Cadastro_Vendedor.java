...
public class Cadastro_Vendedor extends Activity {
	...
	public void AtribuicaoObjetos () {
		btnCancelar = (Button) findViewById(R.CadastroVendedor.btnCancelar);
		btnSalvar = (Button) findViewById(R.CadastroVendedor.btnSalvar);
		edtComissao = (EditText) findViewById(R.CadastroVendedor.EdtComissao);
		edtNome = (EditText) findViewById(R.CadastroVendedor.EdtNome);
		edtSenha = (EditText) findViewById(R.CadastroVendedor.EdtSenha);
	}
