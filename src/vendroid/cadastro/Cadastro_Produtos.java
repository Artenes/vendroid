...
public class Cadastro_Produtos extends Activity{
	...
	public void AtribuicaoObjetos() {
		btnSalvar = (Button) findViewById(R.CadastroProdutos.btnSalvar);
		btnCancelar = (Button) findViewById(R.CadastroProdutos.btnCancelar);
		edtDescricao = (EditText) findViewById(R.CadastroProdutos.EdtDescricao);
		edtCodigoBarra = (EditText) findViewById(R.CadastroProdutos.EdtCodigoBarras);
		edtUnidade = (EditText) findViewById(R.CadastroProdutos.EdtUnidade);
		edtEstoqueAtual = (EditText) findViewById(R.CadastroProdutos.EdtEstoqueAtual);
		edtEstoqueMinimo = (EditText) findViewById(R.CadastroProdutos.EdtEstoqueMinimo);
		edtPrecoCompra = (EditText) findViewById(R.CadastroProdutos.EdtPrecoCompra);
		edtPrecoCusto = (EditText) findViewById(R.CadastroProdutos.EdtPrecoCusto);
		edtVendaVista = (EditText) findViewById(R.CadastroProdutos.EdtVendaVista);
		edtVendaPrazo = (EditText) findViewById(R.CadastroProdutos.EdtVendaPrazo);
		edtMarca = (EditText) findViewById(R.CadastroProdutos.EdtMarca);
		edtGrupo = (EditText) findViewById(R.CadastroProdutos.EdtGrupo);
		edtMarca.setKeyListener(null);
		edtGrupo.setKeyListener(null);
		tglbtnMargemLucro = (ToggleButton) findViewById(R.CadastroProdutos.tglbtnMargemLucro);
		btnMargemLucro = (Button) findViewById(R.CadastroProdutos.btnMargemLucro);
		btnMargemLucro.setEnabled(false);
		edtMargemLucro = (EditText) findViewById(R.CadastroProdutos.edtMargemLucro);
		edtMargemLucro.setEnabled(false);
		edtICMS = (EditText) findViewById(R.CadastroProdutos.edtICMS);
		edtNCM = (EditText) findViewById(R.CadastroProdutos.edtNCM);
		spnSituacaoTributaria = (Spinner) findViewById(R.CadastroProdutos.spnSituacaoTributaria);
	}
